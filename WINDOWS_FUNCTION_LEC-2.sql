...
create database windows10db;
 ...
 use windows10db;
  ...
  INSERT INTO employee_performance (employee_id, employee_name, department, location, performance_year, performance_month,
  salary, sales_amount, rating) VALUES (101, 'Amit', 'Sales', 'Jaipur', 2025, 1, 45000, 120000, 4.2), 
  (102, 'Priya', 'Sales', 'Delhi', 2025, 1, 48000, 135000, 4.5), (103, 'Rahul', 'Sales', 'Jaipur', 2025, 1, 42000, 110000, 3.9),
  (104, 'Neha', 'Sales', 'Mumbai', 2025, 1, 52000, 150000, 4.7), (101, 'Amit', 'Sales', 'Jaipur', 2025, 2, 45000, 140000, 4.4), 
  ...
  select employee_id, employee_name, location, sales_amount, sum(sales_amount) over(order by location),
  sum(sales_amount) over(partition by location) from employee_performance; 
